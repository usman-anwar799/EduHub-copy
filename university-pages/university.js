...
function crElement(type, university, filteredData, elements) {
  if (!type) {
    ...
    cardsCount.innerText = `${filteredData.length} Universities Available`;
    cardsCount.className = "cards-count-byJs";

    const mainHeading = document.createElement("h1");
    mainHeading.innerText = "Find Universities in Pakistan";
    ...
    searchContainer.className = "search-container-byJs";
    ...
    li6.innerText = "Looking for a specific degree instead?";
    ...
    headingSection.className = "heading-section-byJs";
    ...
    cardsSection.className = "cards-section-byJs";
    ...
    paginationSection.className = "pagination-section-byJs";
  ...
  if (type === "card") {
    ...
    icon1.innerHTML = '<i class="fa-solid fa-building-columns"></i>';
    ...
    publicLi.className = "university-type-byJs";

    const universityType = getUniversityType(university);

    publicLi.innerText = universityType
      ? universityType.charAt(0).toUpperCase() +
        universityType.slice(1)
      : "Not Available";

    const trophy = document.createElement("i");
    trophy.className = "fa-solid fa-trophy trophy-1";

    const rankedLi = document.createElement("li");
    rankedLi.innerText = "Not Ranked";
    rankedLi.className = "ranked-li-byJs";
    ...
    description.className = "description-byJs";
    ...
    viewDetails.className = "view-details-byJs";
