const uni = async () => {
  try {
    ...
    data.forEach((university) => {
      ...
      heading.innerText = university.title?.rendered || "University Name";
      ...
      //     university.about_section?.description ||
      //     university.about_section?.discription ||
      //     "No description available.";
      let editedDescription = university.acf.about_section.description;

      let words = editedDescription.split(" ")
      .slice(2,20 )
      .join(" ");
      let descriptionText = `${words + "..."}`;

      let tempDiv = document.createElement("div");

      tempDiv.innerHTML = descriptionText;

      discription.innerText = tempDiv.textContent || tempDiv.innerText;
      ...
      hr1.style.backgroundColor = "rgba(128, 128, 128, 0.20)";
      ...
      li4.style.fontFamily = `'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif`;
