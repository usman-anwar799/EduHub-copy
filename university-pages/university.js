...
const getUniversityType = (university) => {
  ...
  console.log(
    university.acf?.banner_section?.ranking_sources?.rating
  );
...
const crElement = (
  ...
  if (type === "card") {
    ...
    elements.cardsContainer.appendChild(
      box
    );
  }
};
